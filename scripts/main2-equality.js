...
console.log(myVariable != "Percy"); // false (warning: Comparison myVariable != "Percy" may cause unexpected type coercion)
...
console.log(myNumber != 10); // false (warning: Comparison myNumber != 10 may cause unexpected type coercion)
console.log(myNumber == "10"); // true (warning: Comparison myNumber == "10" may cause unexpected type coercion)
console.log(myNumber != "10"); // false (warning: Comparison myNumber != "10" may cause unexpected type coercion)
console.log(myNumber === 10); // true
console.log(myNumber !== 10); // false
console.log(myNumber === "10"); // false !!! (info: Condition is always false since types 'number' and 'string' have no overlap)
console.log(myNumber !== "10"); // true !!! (info: Condition is always true since types 'number' and 'string' have no overlap)
